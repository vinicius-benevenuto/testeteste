...
<body class="{{ 'plain' if plain_bg else '' }}">
  ...
  <nav class="v-nav">
    <a class="v-brand" href="#">
      <span class="v-brand-dot"></span>VIVOHUB
    </a>
    <div class="v-nav-end">
      {% set _role = session.get('role') %}
      {% if _role == 'atacado' %}
        <a class="btn-g btn-sm" href="{{ url_for('central.central_atacado') }}">Central</a>
        <a class="btn-g btn-sm" href="{{ url_for('atacado.form_list') }}">Formulários</a>
      {% elif _role == 'engenharia' %}
        <a class="btn-g btn-sm" href="{{ url_for('central.central_engenharia') }}">Central</a>
        <a class="btn-g btn-sm" href="{{ url_for('engenharia.form_list') }}">Formulários</a>
      {% endif %}
