...
/* ════════════════════════════════════════════════════════════════════════════
   OCULTA O "Drag and drop" QUE APARECE SOBRE O components.html
   O Streamlit renderiza o components.html dentro de um wrapper que pode
   mostrar um stFileUploaderDropzone enquanto carrega. Escondemos tudo isso.
   ════════════════════════════════════════════════════════════════════════════ */
/* Esconde qualquer dropzone que não esteja dentro da página 1 */
[data-testid="stFileUploaderDropzone"],
[data-testid="stFileUploaderDropzoneInstructions"],
[data-testid="stFileUploaderDropzoneInput"] {
  display: none !important;
}
/* Reativa SOMENTE na página de upload (onde o uploader é legítimo) */
...
/* Container do componente HTML — sem borda, sem padding de upload */
