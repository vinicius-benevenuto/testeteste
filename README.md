...
class PTIWorkbookBuilder:
    ...
    def _b_routing(self):
        ...
        for b_idx in range(num_blocks):
            ...
            #
            # COLUNA SEM MERGE (1 valor por linha):
            ...
            # -----------------------------------------------------------
            # LINHAS DE DADOS: tráfego + colunas livres
            # -----------------------------------------------------------
            ...
            for i in range(DATA_ROWS):
                ...
                for col in range(2, 25):
                    ...
                    if col == 9:
                        ...
                        val = sbc_vivo_note if (i == 0 and sbc_vivo_note) else ""
                    else:
                        val = ""  # Colunas livres (BANDA, CANAIS, CAPS, ENCAM, SINAL)
