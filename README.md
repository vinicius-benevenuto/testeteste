...
5) Coluna "Ativação":
   - Preencher automaticamente com "data atual + 90 dias".
   - Formatar como DD/MM/AAAA.
   - A data deve ser calculada no momento da execução (não utilizar datas estáticas).
...
7) Preencher a coluna "Ativação" com data atual + 90 dias (DD/MM/AAAA).
