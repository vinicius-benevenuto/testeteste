...
VALIDAÇÕES FINAIS (pós-concatenação)
  ...
  R2 – Tipo de Rota: preenche vazios/inválidos com ITX-SIP_AS
    ...
    for row_idx, (_, row) in enumerate(df.iterrows()):
        ...
        if arq3_rec:
            ...
            out = {
                ...
                "UF":               "",   # R3 irá preencher
                "CLUSTER":          "",
                "Tipo de Rota":     tipo_rota.upper() or TIPO_ROTA_DEFAULT,
...
def _apply_validacoes_finais(
    ...
    R2 – Tipo de Rota vazio/ausente → preenche com ITX-SIP_AS.
    ...
    for idx in df.index:
        ...
        # ── R2: Tipo de Rota — preenche vazio com ITX-SIP_AS ─────────────
        if "Tipo de Rota" in df.columns:
            ...
            if not tipo_atual:
                ...
                logs.append({
                    ...
                    "mensagem": (
                        f"Correção aplicada: Tipo de Rota preenchido com "
                        f"{TIPO_ROTA_DEFAULT}."
                    ),
                })
