...
/* ── Força modo claro em toda a aplicação ── */
html, body,
.stApp,
...
/* Força texto escuro na área principal (neutraliza modo escuro do sistema) */
...
/* Sidebar — fundo escuro com texto claro explícito */
...
/* Header corporativo — fundo escuro, texto branco explícito */
.corp-header {
...
/* Títulos de seção — cor explícita, não herda do tema */
...
/* Métricas — fundo branco, texto escuro explícito */
...
/* Selectbox / text inputs — fundo e texto explícitos */
