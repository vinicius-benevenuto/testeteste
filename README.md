...
{% block extra_head %}
<style>
  /* Ações primárias e chips já herdados da base (btn-hub / btn-outline-hub) */
    ...
    <div class="col-12 {% if show_files %}col-xxl-8{% else %}col-xxl-12{% endif %}">
      <div class="card-shell">
        <div class="p-4 p-xl-5">
          ...
          {# Paginação — opcional. Renderize apenas se page/pages existirem #}
...
<script>
  ...
  // Live region discreto para feedback (acessibilidade)
  ...
  // Realce do termo buscado no nome da operadora
  (function(){
  ...
  try{
    const linkA = document.createElement('link'); linkA.rel='prefetch'; linkA.href="{{ url_for('engenharia_form_list') }}"; document.head.appendChild(linkA);
  }catch(_){}
</script>
{% endblock %}
