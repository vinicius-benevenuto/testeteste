...
def get_db() -> sqlite3.Connection:
    if "db" not in g:
        ...
        g.db.execute("PRAGMA journal_mode = WAL;")   # muito mais rápido em Docker/Linux
        g.db.execute("PRAGMA synchronous = NORMAL;")  # equilíbrio entre velocidade e segurança
        g.db.execute("PRAGMA cache_size = -64000;")   # 64MB de cache
    return g.db
