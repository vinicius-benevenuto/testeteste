      ...
      <div class="col-lg-7 col-xl-6">
        <div class="admin-card p-4 p-lg-5">
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <a href="{{ url_for('auth.login') }}" class="btn btn-outline-hub btn-sm">← Voltar</a>
          </div>
          ...
          <form method="post" action="{{ url_for('auth.admin_login_post') }}" novalidate id="adminForm">
            <div class="mb-3">
              ...
              <div class="input-group input-group-lg">
                ...
                >
                <button class="btn btn-outline-hub" type="button" id="toggleCode"
                        aria-controls="code" aria-pressed="false">
                  <i class="bi bi-eye"></i>
                </button>
              </div>
