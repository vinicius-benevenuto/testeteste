...
DEFAULT_DIAGRAM_IMAGE: Final[str] = _os.environ.get(
    "DIAGRAM_IMAGE_PATH",
    _os.path.join(_os.path.dirname(__file__), "static", "diagram.png")
)
DEFAULT_SBC_DATA_DIR: Final[str] = _os.environ.get(
    "SBC_DIR",
    _os.path.join(_os.path.dirname(__file__), "dados-sbcs")
)
