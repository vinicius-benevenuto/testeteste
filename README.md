...
{% block extra_head %}
<style>
  /* Hero de fundo com padrão suave */
  .vh-hero{
  ...
  .vh-hero::after{
    ...
    background:
      radial-gradient(300px 300px at 70% 10%, rgba(107,9,166,.08), transparent 60%);
  }
  ...
  /* Botão entrar ocupa largura total, com altura confortável */
  ...
  /* Mensagens inline do formulário */
    ...
    <div class="row align-items-center g-4">
      ...
      <div class="col-lg-6">
        <div class="login-card p-4 p-lg-5">
          ...
          <form method="post" action="{{ url_for('login_post') }}" novalidate autocomplete="on" id="loginForm">
            <div class="mb-3">
            ...
            <div class="mb-2">
              <label for="password" class="form-label fw-semibold d-flex justify-content-between align-items-center">
                <span>Senha</span>
                <button class="btn btn-sm btn-outline-hub" type="button" id="togglePwd" aria-controls="password" aria-pressed="false">
              ...
              <div id="capsMsg" class="caps-hint mt-1"><i class="bi bi-exclamation-triangle-fill me-1"></i> Caps Lock está ativado.</div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              <div class="form-check">
                ...
                <label class="form-check-label text-body-secondary" for="remember">Lembrar sessão (em breve)</label>
              </div>
              <div class="auth-links small">
                <a class="text-body-secondary" href="{{ url_for('admin_login') }}">Sou administrador</a>
              </div>
            </div>
...
<script>
  (function(){
    ...
    btnToggle?.addEventListener('click', ()=>{
      ...
      btnToggle.innerHTML = isText ? '<i class="bi bi-eye"></i> Mostrar' : '<i class="bi bi-eye-slash"></i> Ocultar';
    ...
    // Foco: se o e-mail já vier preenchido pelo navegador, vai para a senha
    window.setTimeout(()=>{
