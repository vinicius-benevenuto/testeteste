...
/* Radio de navegação — esconde o círculo colorido de seleção */
[data-testid="stSidebar"] [data-testid="stRadio"] [data-testid="stWidgetLabel"],
[data-testid="stSidebar"] [data-testid="stRadio"] > div > div > label > div:first-child,
[data-testid="stSidebar"] [data-testid="stRadio"] [role="radio"] {
  display: none !important;
}
/* Faz o label ocupar a linha inteira — clique no texto funciona */
...
/* Item selecionado: destaque suave sem bolinha */
[data-testid="stSidebar"] [data-testid="stRadio"] label[data-checked="true"],
[data-testid="stSidebar"] [data-testid="stRadio"] label[aria-checked="true"] {
  color:            #F1F5F9 !important;
  background:       rgba(27,95,191,.18) !important;
  border-left:      2px solid #1B5FBF !important;
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        'Use o ▽ ao lado de cada coluna para filtrar, ou clique no nome da coluna para ver o dashboard.</p>',
        unsafe_allow_html=True,
    )
