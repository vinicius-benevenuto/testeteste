...
/* ════════════════════════════════════════════════════════════════════════════
   OCULTA PLACEHOLDER DE CARREGAMENTO DO components.html
   O Streamlit mostra um dropzone "Drag and drop file here" enquanto o iframe
   do components.html ainda está sendo carregado. Escondemos esse placeholder.
   Os file uploaders reais de page 1 ficam dentro de [data-testid="stFileUploader"]
   que tem seu próprio estilo — não são afetados.
   ════════════════════════════════════════════════════════════════════════════ */
[data-testid="stFileUploaderDropzoneInstructions"],
[data-testid="stFileUploaderDropzone"] > div:first-child > div,
.stComponentContainer [data-testid="stFileUploaderDropzone"],
iframe + [data-testid="stFileUploaderDropzone"] {
  display: none !important;
}
/* Garante que o iframe do componente não mostra borda de upload */
.element-container:has(iframe) [data-testid="stFileUploader"] {
  display: none !important;
}
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        'Use o simbolo ao lado de cada coluna para filtrar, ou clique no nome da coluna para ver o dashboard.</p>',
        unsafe_allow_html=True,
    )
