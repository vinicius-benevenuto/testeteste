...
(function(){
  ...
  function addOp(v={}){
    ...
    (function(){
      ...
      iSbc?.addEventListener('blur', fmtSbc);
      iEot?.addEventListener('blur', fmtSbc);
      iEot?.addEventListener('change', fmtSbc);
    })();
