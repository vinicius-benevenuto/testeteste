...
def _migrate(engine) -> None:
    """Aplica migrações incrementais para bancos criados em versões anteriores."""
    migrations = [
        # v2: arq3_import_id em mapping_versions
        "ALTER TABLE mapping_versions ADD COLUMN arq3_import_id TEXT REFERENCES imports(id)",
        # v2: source_tag em merged_results
        "ALTER TABLE merged_results ADD COLUMN source_tag TEXT",
        # v2: tabela ref_rotas (criada pelo create_all, mas garante colunas extras)
        "ALTER TABLE ref_rotas ADD COLUMN extra_json TEXT DEFAULT '{}'",
    ]
